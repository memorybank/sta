...
namespace Playa.Item
{
    ...
    public class Gameboy : StageItem
    {
        protected override void InitProperties()
        {
            base.InitProperties();
            _ItemProperties.Name = "Gameboy";
            _ItemProperties.IsMovable = false;
            _StageProperties.ObjectAssetPath = "Assets/Project/Prefabs/SM_GameBoy.prefab";
            //_StageProperties.SoundAssetPath = "Assets/Items/stable/sound/2.wav";
            _StageProperties.PlaneName = "Object_5";
        }
