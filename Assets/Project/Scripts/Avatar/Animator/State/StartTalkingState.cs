...
{
    public class StartTalkingState : AvatarActionState
    {
        ...
        public override bool CanEnterState
        {
            get
            {
                if (Avatar.ActionStateMachine.CurrentState.GetType() == typeof(ActionIdleState) ||
                    Avatar.ActionStateMachine.CurrentState.GetType() == typeof(FinishTalkingState))
                {
                    _AnimationIndex = AvatarUser.MatchBrainBehavior(AvatarStateType.StartTalking);
        ...
        private void OnEnable()
        {
            ...
            // start talking pose shouldn't be looping
